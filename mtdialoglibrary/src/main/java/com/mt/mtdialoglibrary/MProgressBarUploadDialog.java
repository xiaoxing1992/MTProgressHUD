...
public class MProgressBarUploadDialog {
    ...
    private MProgressBarUploadDialog.Builder mBuilder;
    ...
    public MProgressBarUploadDialog(Context context) {
        this(context, new MProgressBarUploadDialog.Builder(context));
    }

    public MProgressBarUploadDialog(Context context, MProgressBarUploadDialog.Builder builder) {
        mContext = context;
        mBuilder = builder;
        if (mBuilder == null) {
            mBuilder = new MProgressBarUploadDialog.Builder(mContext);
        }
        //初始化
        initDialog();
    }
    ...
    private void initDialog() {
        ...
        View mProgressDialogView = inflater.inflate(R.layout.mt_progress_bar_upload_dialog_layout, null);// 得到加载view
    ...
    private void configView() {
        ...
        progress_wheel.setBarWidth(MSizeUtils.dp2px(mContext, mBuilder.circleProgressBarWidth));
    }
    ...
    public void refreshBuilder(MProgressBarUploadDialog.Builder builder) {
        mBuilder = builder;
        if (mBuilder == null) {
            mBuilder = new MProgressBarUploadDialog.Builder(mContext);
        }
    ...
    public static final class Builder {
        ...
        public MProgressBarUploadDialog build() {
            return new MProgressBarUploadDialog(mContext, this);
        }
